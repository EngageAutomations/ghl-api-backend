...
# Deploy Enhanced OAuth Dual-Domain Architecture to Railway
# This script packages and deploys the complete OAuth system

echo "🚀 Deploying Enhanced OAuth System to Railway..."

# Create Railway deployment package
mkdir -p railway-enhanced-oauth
cd railway-enhanced-oauth

# Copy enhanced OAuth files
cp ../server/oauth-enhanced.ts ./oauth-enhanced.js
cp ../server/universal-api-router.ts ./universal-api-router.js
cp ../server/ghl-api-endpoints.ts ./ghl-api-endpoints.js

# Convert TypeScript to JavaScript for Railway
echo "📦 Converting TypeScript to JavaScript..."

# Create main Railway index.js with enhanced OAuth
cat > index.js << 'EOF'
/**
...
cat > package.json << 'EOF'
{
  ...
  "version": "2.0.0",
  "description": "Enhanced OAuth Dual-Domain Architecture for GoHighLevel Marketplace",
  "main": "index.js",
  "scripts": {
    "start": "node index.js",
    "dev": "node index.js"
...
echo "✅ Enhanced OAuth Railway package created!"
echo ""
echo "📋 Deployment Instructions:"
echo "1. Copy the railway-enhanced-oauth folder to your Railway project"
echo "2. Set environment variables in Railway dashboard:"
echo "   - DATABASE_URL (your Neon PostgreSQL connection)"
echo "   - GHL_CLIENT_ID (your GoHighLevel app ID)"
echo "   - GHL_CLIENT_SECRET (your GoHighLevel app secret)"
echo "   - GHL_REDIRECT_URI (https://your-railway-domain.railway.app/api/oauth/callback)"
echo "3. Deploy to Railway"
echo ""
echo "🎯 Features included in this deployment:"
echo "   ✅ Enhanced PKCE OAuth Flow"
echo "   ✅ Universal API Router (50+ endpoints)"
echo "   ✅ Session Recovery System"
echo "   ✅ Automatic Token Management"
echo "   ✅ Cross-Device Compatibility"
echo "   ✅ Dual-Domain Architecture Support"
echo ""
