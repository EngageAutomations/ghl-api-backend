/**
 * Railway Hybrid OAuth Backend v2.1.0
...
console.log('=== Railway Hybrid OAuth Backend v2.1.0 ===');
...
// OAuth callback handler with hybrid credential support
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`🚀 Railway Hybrid OAuth Backend v2.1.0 running on port ${PORT}`);
