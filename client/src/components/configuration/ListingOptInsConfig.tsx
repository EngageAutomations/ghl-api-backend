            ...
            <AccordionContent className="pb-4 pt-2">
              <div className="space-y-6">
                ...
                <div className="space-y-6 pt-4">
                  ...
                  {/* Button Preview and Border Radius in a 2-column layout */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-2">
                    {/* Preview */}
                    <div className="space-y-2">
                      <Label>Button Preview</Label>
                      <div className="border border-slate-200 rounded-md p-4 bg-slate-50 flex justify-center h-[95px]">
                        <div 
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="mt-2">
                        <div className="flex items-center gap-2">
                          <div className="bg-slate-200 w-full h-1 rounded-full">
                            <div 
                              className="bg-indigo-500 h-1 rounded-full" 
                              style={{ width: `${Math.min(100, previewBorderRadius * 5)}%` }}
                            ></div>
                          </div>
                          <div className="text-xs text-slate-500 w-8 text-right">{previewBorderRadius}</div>
                        </div>
                      </div>
                    </div>
                  </div>

                  {/* Button Colors - Two columns */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
