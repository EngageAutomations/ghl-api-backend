    ...
    >
      <div className="space-y-8">
        ...
        <div className="border rounded-md overflow-hidden">
          {/* Toggle Row - Now Outside */}
          <div className="flex justify-between items-center p-4 border-b">
            <div>
              <h3 className="text-base font-medium text-slate-800">Action Button Opt-In</h3>
              <p className="text-sm text-slate-500">Configure a call-to-action button for listings</p>
            </div>
            <Switch 
        ...
        <div className="border rounded-md overflow-hidden">
          ...
          <div className="flex justify-between items-center p-4 border-b">
            <div>
              <h3 className="text-base font-medium text-slate-800">Embedded Form Opt-In</h3>
              <p className="text-sm text-slate-500">Configure a form embedded directly on the listing page</p>
            </div>
            <Switch 
