  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        {/* Styling Options Accordion - Integrated from StylingConfig */}
        <Accordion 
          type="single" 
          collapsible 
          className="w-full border rounded-md"
          ...
          onValueChange={setExpandedSection}
        >
          <AccordionItem value="styling-visibility" className="border-b-0 px-4">
            <div className="flex items-center justify-between py-4">
              {/* Left section: clickable header */}
              <div className="flex-1 cursor-pointer" onClick={() => setExpandedSection(expandedSection === "styling-visibility" ? undefined : "styling-visibility")}>
