...
// Download Button Integration Script
(function() {
  var slug = '';
  var downloadBaseUrl = '${config.downloadUrl || 'https://example.com/downloads/your-file.pdf'}';
  var fieldName = '${config.customFieldName}';
  ...
  function init() {
    ...
    slug = pathSegments[pathSegments.length - 1] || 'demo-product';
          ...
          <Card className="bg-white/90 backdrop-blur-sm border border-purple-200">
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700 block text-left">Listing Title *</Label>
                ...
                {/* 5. Image URL */}
                <div>
                  <Label className="text-sm font-medium text-gray-700 block text-left">Image URL</Label>
                ...
                {/* 8. Metadata Bar Fields - If enabled */}
                {showMetadata && (
                  <div>
                      ...
                      <div className="flex items-end gap-2">
                        <div className="w-16">
                          ...
                          <div className="relative">
                            ...
                            <label
                              htmlFor="icon-upload"
                              className="w-16 h-10 border border-gray-300 rounded flex items-center justify-center bg-white text-xs text-gray-400 cursor-pointer hover:border-gray-400 transition-colors relative group"
                              id="metadata-icon-preview"
                            >
                              <span className="group-hover:opacity-50 transition-opacity">📞</span>
                              <Upload className="w-3 h-3 absolute opacity-0 group-hover:opacity-100 transition-opacity text-gray-600" />
                            </label>
                          </div>
                        </div>
                        <div className="flex-1">
