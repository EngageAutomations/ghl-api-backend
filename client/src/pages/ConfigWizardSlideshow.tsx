...
export default function ConfigWizardSlideshow() {
  ...
  // Create directory mutation with wizard template saving
  const createDirectoryMutation = useMutation({
    mutationFn: async (directoryData: any) => {
      const response = await apiRequest('/api/directories', {
        method: 'POST',
        data: directoryData
      });
      ...
      try {
        await apiRequest('/api/wizard-templates', {
          method: 'POST',
          data: wizardTemplateData
        });
        console.log("Wizard template saved for exact form matching");
      } catch (templateError) {
        console.error("Failed to save wizard template:", templateError);
