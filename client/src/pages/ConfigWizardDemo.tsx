      ...
      <ConfigWizard>
        ...
        >
          <div className="space-y-6">
            ...
            {/* GoHighLevel CSS Preview */}
            {(hideBuyNowButton || hideAddToCartButton || hideQuantitySelector) && (
              <div className="border-t pt-6">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
...
{`<style>
${hideBuyNowButton ? `/* Hide Buy Now Button */
.buy-now-button,
.btn-buy-now,
[class*="buy-now"],
[class*="purchase"],
...
` : ''}${hideAddToCartButton ? `/* Hide Add to Cart Button */
.add-to-cart-button,
.btn-add-cart,
[class*="add-cart"],
[class*="cart"],
...
` : ''}${hideQuantitySelector ? `/* Hide Quantity Selector */
.quantity-selector,
.qty-selector,
.product-quantity,
[class*="quantity"],
