...
div[class*="price"] {
  ...
  // Generate code based on selection - working version with debug logging
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const allSlides = [
    ...
    // Resume with original hardcoded code section for reference
    <Slide key={8}>
      <div className="space-y-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900">Legacy CSS Code (Reference)</h1>
          <p className="text-lg text-slate-600">This is the original hardcoded version for comparison</p>
        </div>

        <div className="space-y-6">
          <div className="space-y-3">
            <Label className="text-lg font-medium">Original CSS Code</Label>
            <div className="bg-slate-900 text-slate-100 p-4 rounded-lg h-80 overflow-auto">
              <pre className="text-sm whitespace-pre-wrap">{`/* Nuclear truncation fix - Apply first to prevent any truncation */
body:not(.hl-builder) * { 
