...
# Create deployment package for existing Railway project
echo "Creating Railway deployment package..."

# Create a clean deployment directory
rm -rf railway-deploy
mkdir -p railway-deploy/server

# Copy and prepare package.json (simplified for Railway)
...
# Convert TypeScript server to JavaScript for Railway
cat > railway-deploy/server/index.js << 'EOF'
...
echo "✅ Railway deployment package created in 'railway-deploy' folder"
echo ""
echo "Next steps:"
echo "1. Upload the files from 'railway-deploy' folder to your Railway project"
echo "2. Set these environment variables in Railway:"
echo "   GHL_CLIENT_ID=68474924a586bce22a6e64f7-mbpkmyu4"
echo "   GHL_CLIENT_SECRET=b5a7a120-7df7-4d23-8796-4863cbd08f94"
...
ls -la railway-deploy/
ls -la railway-deploy/server/